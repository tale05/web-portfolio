...
const skills = [
    { iconListSkill: null, nameListSkill: "TOEIC 605", levelListSkill: "Educational Testing Service (ETS)" },
    { iconListSkill: null, nameListSkill: "GOETHE ZERTIFIKAT A1", levelListSkill: "Goethe-Institut" },
];
