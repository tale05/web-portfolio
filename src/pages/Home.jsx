    ...
    <>
      ...
      <div id="home" className="home-container">
        ...
        <div className="info-panel">
          <img src={img3_thumbnail} alt="My Avatar" className="profile-avatar" />
          ...
          <div className="social-icons">
            <a href="https://github.com/tale05" target="_blank" rel="noopener noreferrer"><FaGithub /></a>
            <a href="https://www.facebook.com/tuananh.lae512" target="_blank" rel="noopener noreferrer"><FaFacebook /></a>
            <a href="https://wa.link/mopwu8" target="_blank" rel="noopener noreferrer"><FaWhatsapp /></a>
            <a href="https://www.instagram.com/__tuananhle__" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
            <a href="mailto:tuananhphamle051202@gmail.com" target="_blank" rel="noopener noreferrer">
              <IoMailOpen />
            </a>
          </div>
